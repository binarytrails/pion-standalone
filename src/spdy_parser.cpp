...
parser::parser()
    : m_read_ptr(nullptr),
    m_uncompressed_ptr(nullptr),
    m_current_data_chunk_ptr(nullptr),
    m_last_data_chunk_ptr(nullptr),
...
pion::tribool parser::parse_spdy_frame(std::error_code& ec,
                                        const decompressor_ptr& decompressor,
...
bool parser::populate_frame(std::error_code& ec,
                            spdy_control_frame_info& frame,
                            uint32_t& length_packet,
                            uint32_t& stream_id,
                            http_protocol_info& http_info)
...
void parser::parse_header_payload(std::error_code &ec,
                                  const decompressor_ptr& decompressor,
...
void parser::parse_spdy_data(std::error_code& /* ec */,
                             const spdy_control_frame_info& frame,
                             uint32_t /* stream_id */,
                             http_protocol_info& http_info)
{
...
void parser::parse_spdy_rst_stream(std::error_code& /* ec */,
                                   const spdy_control_frame_info& frame)
{
...
void parser::parse_spdy_ping_frame(std::error_code& /* ec */,
                                   const spdy_control_frame_info& frame)
{
...
void parser::parse_spdy_settings_frame(std::error_code& /* ec */,
                                       const spdy_control_frame_info& /* frame */)
{
    // Can ignore this frame for our purposes
}

void parser::parse_spdy_goaway_frame(std::error_code &ec,
                                     const spdy_control_frame_info& frame)
{
    // First complete the check for size
    // The length should be 4 always
...
void parser::parse_spdy_window_update_frame(std::error_code& /* ec */,
                                            const spdy_control_frame_info& /* frame */)
{
