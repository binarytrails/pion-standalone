...
protected:
    ...
    bool populate_frame(std::error_code& ec,
     ...
     *
     */
    void parse_header_payload(std::error_code& ec,
                              const decompressor_ptr& decompressor,
     ...
     *
     */
    void parse_spdy_data(std::error_code& ec,
                         const spdy_control_frame_info& frame,
                         uint32_t stream_id,
     ...
     *
     */
    void parse_spdy_settings_frame(std::error_code& ec,
                                   const spdy_control_frame_info& frame);
     ...
     *
     */
    void parse_spdy_rst_stream(std::error_code& ec,
                               const spdy_control_frame_info& frame);
     ...
     *
     */
    void parse_spdy_ping_frame(std::error_code& ec,
                               const spdy_control_frame_info& frame);
     ...
     *
     */
    void parse_spdy_goaway_frame(std::error_code& ec,
                                 const spdy_control_frame_info& frame);
     ...
     *
     */
    void parse_spdy_window_update_frame(std::error_code& ec,
                                        const spdy_control_frame_info& frame);
     ...
     *                        indeterminate = not yet finished parsing SPDY frame
     */
    pion::tribool parse_spdy_frame(std::error_code& ec,
                                    const decompressor_ptr& decompressor,
                                    http_protocol_info& http_headers,
                                    uint32_t& length_packet,
                                    uint32_t current_stream_count);
