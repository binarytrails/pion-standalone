...
public:
    ...
    inline pion::asio::ip::address get_address(void) const { return m_endpoint.address(); }
    
    /// sets IP address that the server listens for connections on
    inline void set_address(const pion::asio::ip::address& addr) { m_endpoint.address(addr); }
    
    /// returns tcp endpoint that the server listens for connections on
    inline const pion::asio::ip::tcp::endpoint& get_endpoint(void) const { return m_endpoint; }
    
    /// sets tcp endpoint that the server listens for connections on
    inline void set_endpoint(const pion::asio::ip::tcp::endpoint& ep) { m_endpoint = ep; }
    ...
    inline pion::asio::ip::tcp::acceptor& get_acceptor(void) { return m_tcp_acceptor; }

    /// returns const reference to the TCP connection acceptor
    inline const pion::asio::ip::tcp::acceptor& get_acceptor(void) const { return m_tcp_acceptor; }
...
protected:
    ...
    inline pion::asio::io_service& get_io_service(void) { return m_active_scheduler.get_io_service(); }
...
private:
    ...
    pion::asio::ip::tcp::acceptor          m_tcp_acceptor;
    ...
    pion::condition_variable                        m_server_has_stopped;

    /// condition triggered when the connection pool is empty
    pion::condition_variable                        m_no_more_connections;
    ...
    pion::asio::ip::tcp::endpoint          m_endpoint;
