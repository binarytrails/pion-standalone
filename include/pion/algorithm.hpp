...
struct PION_API algorithm {
    ...
    static inline pion::uint8_t to_uint8(unsigned char byte) {
        return pion::uint8_t(byte);
    }
    
    /// convert sequence of one byte to 8-bit signed integer
    static inline pion::int8_t to_int8(unsigned char byte) {
        return pion::int8_t(byte);
    }
    
    /// convert sequence of one byte to 8-bit unsigned integer
    static inline pion::uint8_t to_uint8(char byte) {
        return pion::uint8_t(byte);
    }
    
    /// convert sequence of one byte to 8-bit signed integer
    static inline pion::int8_t to_int8(char byte) {
        return pion::int8_t(byte);
    }
    
    /// convert sequence of two bytes to 16-bit unsigned integer
    static inline pion::uint16_t to_uint16(unsigned char high, unsigned char low) {
        return (((pion::uint16_t)high) << 8) | ((pion::uint16_t)low);
    }

    /// convert sequence of two bytes to 16-bit signed integer
    static inline pion::int16_t to_int16(unsigned char high, unsigned char low) {
        return (((pion::int16_t)high) << 8) | ((pion::int16_t)low);
    }

    /// convert sequence of three bytes to 24-bit unsigned integer
    static inline pion::uint32_t to_uint24(unsigned char high, unsigned char mid, unsigned char low) {
        return (((pion::uint32_t)high) << 16) | (((pion::uint32_t)mid) << 8) | ((pion::uint32_t)low);
    }
    
    /// convert sequence of three bytes to 24-bit signed integer
    static inline pion::int32_t to_int24(unsigned char high, unsigned char mid, unsigned char low) {
        return (((pion::int32_t)high) << 16) | (((pion::int32_t)mid) << 8) | ((pion::int32_t)low);
    }
    
    /// convert sequence of four bytes to 32-bit unsigned integer
    static inline pion::uint32_t to_uint32(unsigned char high, unsigned char mid1, unsigned char mid2, unsigned char low) {
        return (((pion::uint32_t)high) << 24) | (((pion::uint32_t)mid1) << 16) | (((pion::uint32_t)mid2) << 8) | ((pion::uint32_t)low);
    }
    
    /// convert sequence of four bytes to 32-bit signed integer
    static inline pion::int32_t to_int32(unsigned char high, unsigned char mid1, unsigned char mid2, unsigned char low) {
        return (((pion::int32_t)high) << 24) | (((pion::int32_t)mid1) << 16) | (((pion::int32_t)mid2) << 8) | ((pion::int32_t)low);
    }
    
    /// convert sequence of eight bytes to 64-bit unsigned integer
    static inline pion::uint64_t to_uint64(unsigned char high, unsigned char mid1, unsigned char mid2, unsigned char mid3, unsigned char mid4, unsigned char mid5, unsigned char mid6, unsigned char low) {
        return (((pion::uint64_t)high) << 56) | (((pion::uint64_t)mid1) << 48) | (((pion::uint64_t)mid2) << 40) | (((pion::uint64_t)mid3) << 32)
            | (((pion::uint64_t)mid4) << 24) | (((pion::uint64_t)mid5) << 16) | (((pion::uint64_t)mid6) << 8) | ((pion::uint64_t)low);
    }
    
    /// convert sequence of eight bytes to 64-bit signed integer
    static inline pion::int64_t to_int64(unsigned char high, unsigned char mid1, unsigned char mid2, unsigned char mid3, unsigned char mid4, unsigned char mid5, unsigned char mid6, unsigned char low) {
        return (((pion::int64_t)high) << 56) | (((pion::int64_t)mid1) << 48) | (((pion::int64_t)mid2) << 40) | (((pion::int64_t)mid3) << 32)
        | (((pion::int64_t)mid4) << 24) | (((pion::int64_t)mid5) << 16) | (((pion::int64_t)mid6) << 8) | ((pion::int64_t)low);
    }

    /// convert sequence of two bytes to 16-bit unsigned integer
    template <typename T1, typename T2>
    static inline pion::uint16_t to_uint16(T1 high, T2 low) {
        return to_uint16(static_cast<unsigned char>(high), static_cast<unsigned char>(low));
    }
    
    /// convert sequence of two bytes to 16-bit signed integer
    template <typename T1, typename T2>
    static inline pion::int16_t to_int16(T1 high, T2 low) {
        return to_int16(static_cast<unsigned char>(high), static_cast<unsigned char>(low));
    }
    
    /// convert sequence of three bytes to 24-bit unsigned integer
    template <typename T1, typename T2, typename T3>
    static inline pion::uint32_t to_uint24(T1 high, T2 mid, T3 low) {
    ...
    /// convert sequence of three bytes to 24-bit signed integer
    template <typename T1, typename T2, typename T3>
    static inline pion::int32_t to_int24(T1 high, T2 mid, T3 low) {
    ...
    static inline pion::uint32_t to_uint32(T1 high, T2 mid1, T3 mid2, T4 low) {
    ...
    /// convert sequence of four bytes to 32-bit signed integer
    template <typename T1, typename T2, typename T3, typename T4>
    static inline pion::int32_t to_int32(T1 high, T2 mid1, T3 mid2, T4 low) {
    ...
    static inline pion::uint64_t to_uint64(T1 high, T2 mid1, T3 mid2, T4 mid3, T5 mid4, T6 mid5, T7 mid6, T8 low) {
    ...
    /// convert sequence of eight bytes to 64-bit signed integer
    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>
    static inline pion::int64_t to_int64(T1 high, T2 mid1, T3 mid2, T4 mid3, T5 mid4, T6 mid5, T7 mid6, T8 low) {
    ...
    static inline pion::uint8_t to_uint8(const Byte *buf) {
        return to_uint8(buf[0]);
    }
    
    /// convert byte pointer into an 8-bit signed integer
    template <typename Byte>
    static inline pion::int8_t to_int8(const Byte *buf) {
        return to_int8(buf[0]);
    }
    
    /// convert sequence of two bytes to 16-bit unsigned integer
    template <typename Byte>
    static inline pion::uint16_t to_uint16(const Byte *buf) {
        return to_uint16(buf[0], buf[1]);
    }
    
    /// convert sequence of two bytes to 16-bit signed integer
    template <typename Byte>
    static inline pion::int16_t to_int16(const Byte *buf) {
        return to_int16(buf[0], buf[1]);
    }
    
    /// convert sequence of three bytes to 24-bit unsigned integer
    template <typename Byte>
    static inline pion::uint32_t to_uint24(const Byte *buf) {
        return to_uint24(buf[0], buf[1], buf[2]);
    }
    
    /// convert sequence of three bytes to 24-bit signed integer
    template <typename Byte>
    static inline pion::int32_t to_int24(const Byte *buf) {
        return to_int24(buf[0], buf[1], buf[2]);
    }
    
    /// convert sequence of four bytes to 32-bit unsigned integer
    template <typename Byte>
    static inline pion::uint32_t to_uint32(const Byte *buf) {
        return to_uint32(buf[0], buf[1], buf[2], buf[3]);
    }
    
    /// convert sequence of four bytes to 32-bit signed integer
    template <typename Byte>
    static inline pion::int32_t to_int32(const Byte *buf) {
        return to_int32(buf[0], buf[1], buf[2], buf[3]);
    }
    
    /// convert sequence of eight bytes to 64-bit unsigned integer
    template <typename Byte>
    static inline pion::uint64_t to_uint64(const Byte *buf) {
        return to_uint64(buf[0], buf[1], buf[2], buf[3], buf[4], buf[5], buf[6], buf[7]);
    }
    
    /// convert sequence of eight bytes to 64-bit signed integer
    template <typename Byte>
    static inline pion::int64_t to_int64(const Byte *buf) {
        return to_int64(buf[0], buf[1], buf[2], buf[3], buf[4], buf[5], buf[6], buf[7]);
    }

    /// convert 8-bit unsigned integer into sequence of one byte
    template <typename Byte>
    static inline void from_uint8(Byte *buf, const pion::uint8_t n) {
        buf[0] = n & 0xFF;
    }
    
    /// convert 8-bit signed integer into sequence of one byte
    template <typename Byte>
    static inline void from_int8(Byte *buf, const pion::int8_t n) {
        buf[0] = n & 0xFF;
    }
    
    /// convert 16-bit unsigned integer into sequence of two bytes
    template <typename Byte>
    static inline void from_uint16(Byte *buf, const pion::uint16_t n) {
        buf[0] = (n >> 8) & 0xFF;
        buf[1] = n & 0xFF;
    }
    ...
    template <typename Byte>
    static inline void from_int16(Byte *buf, const pion::int16_t n) {
        buf[0] = (n >> 8) & 0xFF;
        buf[1] = n & 0xFF;
    }
    ...
    template <typename Byte>
    static inline void from_uint24(Byte *buf, const pion::uint32_t n) {
        buf[0] = (n >> 16) & 0xFF;
        buf[1] = (n >> 8) & 0xFF;
        buf[2] = n & 0xFF;
    }
    ...
    template <typename Byte>
    static inline void from_int24(Byte *buf, const pion::int32_t n) {
        buf[0] = (n >> 16) & 0xFF;
        buf[1] = (n >> 8) & 0xFF;
        buf[2] = n & 0xFF;
    }
    ...
    template <typename Byte>
    static inline void from_uint32(Byte *buf, const pion::uint32_t n) {
        buf[0] = (n >> 24) & 0xFF;
        buf[1] = (n >> 16) & 0xFF;
        buf[2] = (n >> 8) & 0xFF;
        buf[3] = n & 0xFF;
    ...
    template <typename Byte>
    static inline void from_int32(Byte *buf, const pion::int32_t n) {
        buf[0] = (n >> 24) & 0xFF;
        buf[1] = (n >> 16) & 0xFF;
        buf[2] = (n >> 8) & 0xFF;
        buf[3] = n & 0xFF;
    ...
    template <typename Byte>
    static inline void from_uint64(Byte *buf, const pion::uint64_t n) {
        buf[0] = (n >> 56) & 0xFF;
        buf[1] = (n >> 48) & 0xFF;
        buf[2] = (n >> 40) & 0xFF;
        buf[3] = (n >> 32) & 0xFF;
    ...
    template <typename Byte>
    static inline void from_int64(Byte *buf, const pion::int64_t n) {
        buf[0] = (n >> 56) & 0xFF;
        buf[1] = (n >> 48) & 0xFF;
        buf[2] = (n >> 40) & 0xFF;
        buf[3] = (n >> 32) & 0xFF;
